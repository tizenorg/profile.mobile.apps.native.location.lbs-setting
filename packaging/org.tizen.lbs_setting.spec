...
%if 0%{?model_build_feature_location_position_wps}
	buxton2ctl set-int32 system db/location/setting/NetworkEnabled 1
%else
	buxton2ctl set-int32 system db/location/setting/NetworkEnabled 0
%endif

%if "%{profile}" == "wearable"
	buxton2ctl set-int32 system db/location/setting/GpsPopup 0
%else
	buxton2ctl set-int32 system db/location/setting/GpsPopup 1
%endif
